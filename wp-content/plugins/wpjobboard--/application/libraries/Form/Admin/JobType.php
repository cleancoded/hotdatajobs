...
class Wpjb_Form_Admin_JobType extends Daq_Form_ObjectAbstract
{
    ...
    public function init()
    {
        ...
        $e->setValue(Wpjb_Model_Tag::TYPE_TYPE);
        $this->addElement($e);

        $e = $this->create("title");
        $e->setRequired(true);
        $e->setValue($this->_object->title);
        $e->setLabel(__("Job Type Title","wpjobboard"));
        ...
        $e->setLabel(__("Job Type Slug", "wpjobboard"));
        ...
        $e->setValue($this->_object->meta->color);
    ...
    public function save($append = array()) 
    {
        ...
        apply_filters("wpja_form_save_jobtype", $this);
    }
}
