...
var WpjbImportUrl = {
    ...
    count: "<?php echo html_entity_decode(wpjb_admin_url("import", "csvcount", null, array("noheader"=>1))) ?>",
    import: "<?php echo html_entity_decode(wpjb_admin_url("import", "csvimport", null, array("noheader"=>1))) ?>"
};
var WpjbCanUnzip = 0;
var WpjbImport = {
    filters: [
