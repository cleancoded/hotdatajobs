...
<div class="wpjb wpjb-job wpjb-page-single">
    ...
    <div class="wpjb-job-apply" style="margin:24px 0px;">
        ...
        <div>
            ...
            <a class="wpjb-button button-darkteal" href="<?php esc_attr_e(add_query_arg("goto-job", $job->id, wpjr_link_to("register"))) ?>"><?php _e("Register", "wpjobboard") ?></a>
    ...
    <div class="wpjb-job-apply" id="wpjb-scroll" style="margin:12px 0px;">
        <div class="wpjb-job-buttons">
            ...
            <a class="wpjb-button button-darkteal" href="<?php esc_attr_e($application_url) ?>"><?php _e("Apply to this Job", "wpjobboard") ?></a>
            <?php else: ?>
            <a class="button button-darkteal wpjb-form-toggle wpjb-form-job-apply" href="<?php esc_attr_e(wpjb_link_to("job", $job, array("form"=>"apply"))) ?>#wpjb-scroll" rel="nofollow" data-wpjb-form="wpjb-form-job-apply"><?php _e("Apply to this Job", "wpjobboard") ?>
...
<!--             <?php do_action("wpjb_tpl_single_actions", $job, $can_apply) ?> -->
	...
	<div class="company_info">
		<div class="info_header">
			<img src="<?php echo $company->getLogoUrl(); ?>">
			<span class="company_details">
				<?php echo '<span class="company_name">'.$company->company_name.'</span><br/>'; ?>
				<?php echo '<span class="inner_key">Website </span><span class="inner_value">'.$company->company_website.'</span><br/>'; ?>
				<?php echo '<span class="inner_key">Type </span><span class="inner_value">'.$company->meta->company_tp->value().'</span><br/>'; ?>
				<?php echo '<span class="inner_key">Size </span><span class="inner_value">'.$company->meta->company_size->value().'</span><br/>'; ?>
			</span>
		</div>
		<div class="info_content">
			<?php echo $company->company_info; ?>
		</div>
	</div>
